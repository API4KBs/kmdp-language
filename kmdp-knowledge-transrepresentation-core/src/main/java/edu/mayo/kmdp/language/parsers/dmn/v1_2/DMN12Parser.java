...
@KPSupport(DMN_1_2)
public class DMN12Parser extends XMLBasedLanguageParser<TDefinitions>
    implements DeserializeApiOperator {

  public static final UUID id = UUID.fromString("afed464f-2651-4537-ab1b-4e02977b1295");
  public static final String version = "1.0.0";

  public DMN12Parser() {
    setId(newId(id, version));
